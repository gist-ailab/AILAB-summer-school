...
background_target_position = np.array([[0.1,0.8,0.0],[0.5,0.3,0.0]])


############### Random한 ShapeNet 물체 생성을 포함하는 Task 생성 ######################
# ShapeNet Dataset 물체들에 대한 정보 취득
# PRACTICE 1: shapenet directory path
shapenet_dir = 
# PRACTICE 2: usd file path list 
obj_files = 
obj_files.sort()
object_info = {}
...
# PRACTICE 3: class argument 채우기
# Task 생성
my_task = UR5ePickPlace(objects_list = ,
                        objects_position = ,
                        background_objects_list = ,
