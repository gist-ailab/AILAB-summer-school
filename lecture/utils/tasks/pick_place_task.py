...
class UR5ePickPlace(tasks.PickPlace):
    ...
    def set_camera(self):
        ...
        # for object_number in range(len(self.imported_objects)):
        #     add_update_semantics(prim=self.imported_objects_prim_path + f"_{object_number}", semantic_label=f"{object_number}")
